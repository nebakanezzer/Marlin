...
#define STRING_CONFIG_H_AUTHOR "(Brian)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CARNAGE"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  31.83,  31.83 }
    #define DEFAULT_Ki_LIST {   3.21,   3.21 }
    #define DEFAULT_Kd_LIST { 78.88, 78.88 }
  #else
    #define DEFAULT_Kp  31.83
    #define DEFAULT_Ki   3.21
    #define DEFAULT_Kd 78.88
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 409.29 }
